...
describe('generate items', () => {
  ...
  let rootPath;
  beforeEach(() => {
    fileSystem = ['path/to/file1.js', 'path/to/file2.js', 'path/to/file3.js'];
    rootPath = 'root/path';
  });
  ...
  describe('Validates fileSystem', () => {
    it('should return an error message when fileSystem is undefined', () => {
      expect(generateItems(undefined, rootPath)).toEqual(
  ...
  describe('Validates rootPath', () => {
    ...
    it('should return an error message when rootPath is not a string', () => {
      expect(generateItems(fileSystem, 123)).toEqual(
        'rootPath has to be a string',
      );
    });
  });
});
